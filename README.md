...
```
## training
* cd caffe-fast-rcnn and modify the Makefile.config
* make -j8 && make pycaffe
* modify stage1_fast_rcnn_train.pt, stage1_rpn_train.pt,
stage2_fast_rcnn_train.pt, stage2_rpn_train.pt,
faster_rcnn_test.pt, pascal_voc.py for the right num_classes and label
* modify train_faster_rcnn_alt_opt.py for training iters
* example: run ```./experiments/scripts/faster_rcnn_alt_opt.sh 0 ZF pascal_voc ```
